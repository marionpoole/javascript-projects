...
let blanket = cargoHold.pop();
console.log('Element removed: ' + blanket);
console.log(cargoHold);

//3) Remove the first item from the array with shift. Print the element removed and the updated array.
let tanks = cargoHold.shift();
console.log('Element romoved: ' + tanks);
console.log(cargoHold);
...
console.log(`${cargoHold}, Length of the final array is: ${cargoHold.length}`);